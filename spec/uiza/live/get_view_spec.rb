...
RSpec.describe Uiza::Live do
  ...
  describe "::get_view" do
    context "API returns code 200" do
      it "should returns an object with stream_name, watchnow and day" do
        id = "your-live-id"
        ...
        response = Uiza::Live.get_view id

        expect(response.stream_name).to eq "your-stream-name"
        expect(response.watchnow).to eq 1
        expect(response.day).to eq 1
