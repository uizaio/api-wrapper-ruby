  ...
  describe "::delete" do
    context "API returns code 200" do
      it "should returns an id" do
        ...
        response = Uiza::Entity.delete id

        expect(response.id).to eq "your-entity-id"
    ...
    def api_return_error_code error_code, error_class
      ...
      expect{Uiza::Entity.delete id}.to raise_error do |error|
        expect(error).to be_a error_class
        expect(error.description_link).to eq "https://dev-ap-southeast-1-api.uizadev.io/docs/#api-Media-delete_entity"
