  ...
  describe "::update" do
    context "API returns code 200" do
      it "should returns a callback" do
        ...
        expected_url_1 = "https://stag-ap-southeast-1-api.uizadev.io/api/public/v4/media/entity/callback"
        ...
        expected_url_2 = "https://stag-ap-southeast-1-api.uizadev.io/api/public/v4/media/entity/callback"
    ...
    def api_return_error_code error_code, error_class
      ...
      expect{Uiza::Callback.update params}.to raise_error do |error|
        ...
        expect(error.description_link).to eq "https://dev-ap-southeast-1-api.uizadev.io/docs/#api-Media_Callback-update_entity_callback"
